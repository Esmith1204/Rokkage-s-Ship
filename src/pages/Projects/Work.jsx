            ...
            <div className="flex flex-col w-full py-20 pb-32" style={{ position: 'relative', zIndex: 0 }}>
                <div className="w-full max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-6">
                        ...
                        <a
                            href="https://untitled-tab-app.vercel.app"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="card bg-base-100 shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200 overflow-hidden"
                            aria-label="Open Untitled Tab App"
                        >
                            <figure className="h-48 w-full overflow-hidden bg-neutral">
                                <img
                                    src={tabapp}
                                    alt="Tab App project screenshot"
                                    className="w-full h-full object-cover"
                                />
                            </figure>
                            <div className="card-body items-center text-center">
                                <h2 className="card-title">Untitled Tab App</h2>
                                <p className="text-sm">A web app I made for managing restaurant payments.</p>
                                <div className="card-actions">
